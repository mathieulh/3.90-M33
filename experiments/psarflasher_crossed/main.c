...
/* 0x0800 -> vsh */
PSP_MODULE_INFO("PsarFlasher", 0x1000, 1, 0);
...
#define EXTRACT_PRXS	"ms0:/PSP/GAME/RECOVERY/extprxs.pbp"
...
void Update()
{
	...
	int res = sceIoAssign("flash0:", "lflash0:0,0", "flashfat0:", 0, IOASSIGN_RDWR , 0);
	printf("Assign flash0: %08X\n", res);
	res = sceIoAssign("flash1:", "lflash0:0,1", "flashfat1:", 0, IOASSIGN_RDWR , 0);
	printf("Assign flash1: %08X\n", res);
...
int main(int argc, char *argv[])
{
	...
	if (scePowerGetBatteryLifePercent() < 10)
	{
		if (!ByPass())
		{
			ErrorExit(6000, "Battery has to be at least at 10%%.\n");
		}
	}
