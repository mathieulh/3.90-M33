...
int (* sceBootLfatOpen)(char *file) = (void *)0x88607e98;
...
int entry(void *a0, void *a1, void *a2, void *a3)
{
	...
	_sw(0xafa50000, 0x88604480);	
	_sw(0x20a30000, 0x88604484);
	...
	// 88604340: jr $s1 -> mov $a3, $s1 /* a3 = LoadCore module_start */
	// 88604344: mov $sp, $s5 -> j PatchLoadCore
	// 88604348: nop -> mov $sp, $s5
	_sw(0x00113821, 0x88604340);
	MAKE_JUMP(0x88604344, PatchLoadCore);
	_sw(0x02a0e821, 0x88604348);	
