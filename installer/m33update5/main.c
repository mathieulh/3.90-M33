...
int main(void)
{
	...
	if (sctrlSEGetVersion() <= 0x1022)
	{
		printf("- Reverted back to previous galaxy.prx,as the one gave problems with slow memory sticks.\n");
	}

	printf("- Fixed custom CPU clock not working in games\n"
		   "- CPU clock was not set at all in games that restarted using\n"
		   "  sceKernelLoadExec\n"
