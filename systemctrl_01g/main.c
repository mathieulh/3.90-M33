...
PSP_MODULE_INFO("SystemControl", 0x3007, 1, 5);
...
void PatchMemlmd()
{
	...
	UnsignCheck = (void *)(text_addr+0x0F10);

	MAKE_CALL(text_addr+0x0E10, KDecryptPatched);
	MAKE_CALL(text_addr+0x0E74, KDecryptPatched);
