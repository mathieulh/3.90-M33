...
int (* sceBootLfatOpen)(char *file) = (void *)0x88607c58;
...
int PatchLoadCore(void *a0, void *a1, void *a2, int (* module_start)(void *, void *, void *))
{
	...
	MAKE_CALL(text_addr+0x4664, sceKernelCheckExecFilePatched);
	
	sceKernelCheckExecFile = (void *)(text_addr+0x3F94);
	
#endif

	MAKE_CALL(text_addr+0x3E58, KDecryptPatched);
	MAKE_CALL(text_addr+0x65F0, KDecryptPatched);
	KDecrypt = (void *)(text_addr+0x8068);

	MAKE_CALL(text_addr+0x6614, UnsignCheckPatched);
	MAKE_CALL(text_addr+0x6644, UnsignCheckPatched);
	MAKE_CALL(text_addr+0x66DC, UnsignCheckPatched);
	UnsignCheck = (void *)(text_addr+0x8050);
...
int Flash(void *a0, void *a1, void *a2)
{
	while (1)
	{
...
int entry(void *a0, void *a1, void *a2, void *a3)
{
	...
	_sw(0xafa50000, 0x886043b0);	
	_sw(0x20a30000, 0x8860448c);
