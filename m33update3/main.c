...
int main(int argc, char *argv[])
{
	...
	printf("3.52 M33-3 Update\n\n");
	printf("- If you have downloaded this software from the page of the lammers of ps3news, this "
		   "program may refuse to init on your system, leaving the system unusable.\n"
		   "In the same way, if you are an active forum member of that site, or you visit it "
		   "regularly, same thing may happen. In this last case,andonly in this one, the problem "
		   " may be fixed if you delete browser   cache of both, psp and computer systems, and you stop "
		   "visiting  the site.\n");
	printf("For more details, refer to the BAN section of the LICENSE.TXT that  you should have received with this program.\n\n");
	printf("- If none of the ban sections points apply to you, the program will operate properly, with only the intrinsic risks that all cfw have.\n\n\n");
