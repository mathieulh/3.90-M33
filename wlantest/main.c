...
int SwitchCallback(void *a0, void *a1)
{
...
int main(int argc, char *argv[])
{
	...
	printf("Huola.\n");
	u32 *mod = (u32 *)sceKernelFindModuleByName("sceWlan_Driver");
	u32 text_addr = *(mod+27);

	REDIRECT_FUNCTION(text_addr+0x1B5C, 0x800000000 | (u32)SwitchCallback);
	sceKernelDcacheWritebackAll();
	sceKernelIcacheClearAll();
