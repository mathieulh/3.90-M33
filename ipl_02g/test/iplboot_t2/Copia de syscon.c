...
int pspSyscon_end()
{
	REG32(0xbe240010) = saved[0];
	REG32(0xbe240014) = saved[1];
	REG32(0xbe240018) = saved[2];
	REG32(0xbe240024) = saved[3];
	REG32(0xbe24000c) = saved[4];
	REG32(0xbe240000) = saved[5];

	REG32(0xbe580000) = saved[6];
	REG32(0xbe580004) = saved[7];
	REG32(0xbe580014) = saved[8];
	REG32(0xbe580024) = saved[9];

	Sysreg_driver_Unkonow_d6628a48(0,1);

	REG32(0xbc100078) = saved[10];
